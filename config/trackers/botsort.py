...
class BotSortConfig:
    ...
    max_age: int = 70  # Макс. количество кадров пропуска до удаления ID
    max_obs: int = 120  # Макс. количество наблюдений (кадров) для хранения истории

    match_thresh: float = 0.4  # Порог геометрического совпадения (IoU)
